...
const routes = [
	...
	{ name: 'Playlist', path: '/playlist', icon: <PlaylistAddIcon /> },
	{ name: 'Discover', path: '/discover', icon: <PlaylistAddIcon /> },
];
	...
	const drawer = (
		<div>
			<Box style={{ padding: 10, textAlign: 'center' }}>
				<img
					alt="logo"
					src={require('/Users/rishikapatwa/Desktop/utility/client/src/assets/logo.jpg')}
					style={{ width: '40%' }}
				/>
			</Box>
